...
if __name__ == '__main__':
    ...
    # Use num_workers from args exactly as specified
    ...
    train_loader = OptimizedDataLoader(
        ...
        shuffle=True,
        num_workers=num_workers,
        pin_memory=False, # args.accelerator == 'gpu' and torch.cuda.is_available(),
        collate_fn=collate_fn_with_nps,
        drop_last=False,  # Drop last for consistent batch sizes
    ).loader
    ...
    # Note: DataLoader testing is skipped to avoid pickling issues with parser objects.
    # The dataloader will be tested during the first training batch.
